...
<div class="col">
    ...
    <form action="/CatatanKegwargaCon/save" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_dusun" name="jml_dusun" value="<?= old('jml_dusun'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_rw" class="col-sm-3 col-form-label">Jumlah RW</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_rw" name="jml_rw" value="<?= old('jml_rw'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_rt" class="col-sm-3 col-form-label">Jumlah RT</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_rt" name="jml_rt" value="<?= old('jml_rt'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_dasawisma" class="col-sm-3 col-form-label">Jumlah dasawisma</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_dasawisma" name="jml_dasawisma" value="<?= old('jml_dasawisma'); ?>">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="col">
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_angt_keluarga_totL" name="jml_angt_keluarga_totL" value="<?= old('jml_angt_keluarga_totL'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_angt_keluarga_totP" class="col-sm-3 col-form-label">Total (Perempuan)</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_angt_keluarga_totP" name="jml_angt_keluarga_totP" value="<?= old('jml_angt_keluarga_totP'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_angt_keluarga_balitaL" class="col-sm-3 col-form-label">Balita (Laki-laki)</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_angt_keluarga_balitaL" name="jml_angt_keluarga_balitaL" value="<?= old('jml_angt_keluarga_balitaL'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_angt_keluarga_balitaP" class="col-sm-3 col-form-label">Balita (Laki-laki)</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_angt_keluarga_balitaP" name="jml_angt_keluarga_balitaP" value="<?= old('jml_angt_keluarga_balitaP'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_angt_keluarga_pus" class="col-sm-3 col-form-label">Pasangan Usia Subur (PUS)</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_angt_keluarga_pus" name="jml_angt_keluarga_pus" value="<?= old('jml_angt_keluarga_pus'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_angt_keluarga_wus" class="col-sm-3 col-form-label">Wanita Usia Subur (WUS)</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_angt_keluarga_wus" name="jml_angt_keluarga_wus" value="<?= old('jml_angt_keluarga_wus'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_angt_keluarga_ibuhml" class="col-sm-3 col-form-label">Ibu hamil</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_angt_keluarga_ibuhml" name="jml_angt_keluarga_ibuhml" value="<?= old('jml_angt_keluarga_ibuhml'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_angt_keluarga_ibunyusu" class="col-sm-3 col-form-label">Ibu menyusui</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_angt_keluarga_ibunyusu" name="jml_angt_keluarga_ibunyusu" value="<?= old('jml_angt_keluarga_ibunyusu'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_angt_keluarga_lansia" class="col-sm-3 col-form-label">Lansia</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_angt_keluarga_lansia" name="jml_angt_keluarga_lansia" value="<?= old('jml_angt_keluarga_lansia'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_angt_keluarga_butaL" class="col-sm-3 col-form-label">3 Buta (Laki-laki)</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_angt_keluarga_butaL" name="jml_angt_keluarga_butaL" value="<?= old('jml_angt_keluarga_butaL'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_angt_keluarga_butaP" class="col-sm-3 col-form-label">3 Buta (Perempuan)</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_angt_keluarga_butaP" name="jml_angt_keluarga_butaP" value="<?= old('jml_angt_keluarga_butaP'); ?>">
                </div>
            </div>
        </div>
        <hr>
        ...
        <div class="col">
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_rmh_sehat" name="jml_rmh_sehat" value="<?= old('jml_rmh_sehat'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_rmh_krgsehat" class="col-sm-3 col-form-label">Jumlah rumah kurang sehat</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_rmh_krgsehat" name="jml_rmh_krgsehat" value="<?= old('jml_rmh_krgsehat'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_rmh_sampah" class="col-sm-3 col-form-label">Jumlah rumah memiliki tempat pembuangan sampah</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_rmh_sampah" name="jml_rmh_sampah" value="<?= old('jml_rmh_sampah'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_rmh_spal" class="col-sm-3 col-form-label">Jumlah rumah memiliki SPAL</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_rmh_spal" name="jml_rmh_spal" value="<?= old('jml_rmh_spal'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_rmh_p4k" class="col-sm-3 col-form-label">Jumlah rumah menempel stiker P4K</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_rmh_p4k" name="jml_rmh_p4k" value="<?= old('jml_rmh_p4k'); ?>">
                </div>
            </div>
        </div>
        <hr>
        ...
        <div class="col">
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_airkel_pdam" name="jml_airkel_pdam" value="<?= old('jml_airkel_pdam'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_airkel_sumur" class="col-sm-3 col-form-label">Jumlah pemakai sumur</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_airkel_sumur" name="jml_airkel_sumur" value="<?= old('jml_airkel_sumur'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_airkel_sungai" class="col-sm-3 col-form-label">Jumlah pemakai sungai</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_airkel_sungai" name="jml_airkel_sungai" value="<?= old('jml_airkel_sungai'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_airkel_lain" class="col-sm-3 col-form-label">Jumlah pemakai lain-lain</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_airkel_lain" name="jml_airkel_lain" value="<?= old('jml_airkel_lain'); ?>">
                </div>
            </div>
        </div>
        <hr>
        <div class="form-group row pt-3">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_jamban_kel" name="jml_jamban_kel" value="<?= old('jml_jamban_kel'); ?>">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="col">
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_wrg_up2k" name="jml_wrg_up2k" value="<?= old('jml_wrg_up2k'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_wrg_mnfaat_tanah" class="col-sm-3 col-form-label">Pemanfaatan tanah pekarangan</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_wrg_mnfaat_tanah" name="jml_wrg_mnfaat_tanah" value="<?= old('jml_wrg_mnfaat_tanah'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_wrg_industrirt" class="col-sm-3 col-form-label">Industri rumah tangga</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_wrg_industrirt" name="jml_wrg_industrirt" value="<?= old('jml_wrg_industrirt'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_wrg_keslingk" class="col-sm-3 col-form-label">Kesehatan lingkungan</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_wrg_keslingk" name="jml_wrg_keslingk" value="<?= old('jml_wrg_keslingk'); ?>">
                </div>
            </div>
        </div>
        <hr>

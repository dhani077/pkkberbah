...
<div class="col">
    <form action="/bukuinventaris/lihatrange" method="post" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <p><b>Data Inventaris</b></p>
        <div class="form-group col">
            <label for="awal" class="col-sm">Dari tanggal terima/beli</label>
            <div class="col-sm-3">
                <div class="custom-file">
                    <select class="form-control <?= ($validation->hasError('range')) ? 'is-invalid' : ''; ?>" id="awal" name="awal" autofocus>
                        <?php foreach ($bukuinven as $bi) : ?>
                            <option value="<?= $bi['tgl_terima_beli']; ?>"><?= $bi['tgl_terima_beli']; ?></option>
                        <?php endforeach; ?>
                    </select>
            ...
            <br>
            <label for="akhir" class="col-sm">sampai tanggal terima/beli</label>
            <div class="col-sm-3">
                <div class="custom-file">

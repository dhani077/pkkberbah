...
<div class="col">
    ...
    <br><br>
    <?php if ($buku) : ?>
        <a href="/tamanbacaan/print/<?= $taman['kd_taman']; ?>" class="btn btn-outline-secondary">Cetak</a>
    <?php endif; ?>
    <a href="/tamanbacaan/detailrange/<?= $kdwilayah; ?>" class="btn btn-danger">Kembali</a>
</div>
<?= $this->endsection(); ?>
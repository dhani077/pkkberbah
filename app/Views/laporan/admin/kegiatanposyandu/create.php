...
<div class="col">
    ...
    <form action="/KegiatanposyanduCon/save/<?= $kdPosyandu; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_ibu_hamil" name="jml_ibu_hamil" value="<?= old('jml_ibu_hamil'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_diperiksa" class="col-sm-5 col-form-label">Jumlah Yang Diperiksa</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_diperiksa" name="jml_diperiksa" value="<?= old('jml_diperiksa'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_fe_tab" class="col-sm-5 col-form-label">Jumlah Yang Mendapat Tablet Zat Besi</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_fe_tab" name="jml_fe_tab" value="<?= old('jml_fe_tab'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_ibu_nyusu" class="col-sm-5 col-form-label">Jumlah Ibu Menyusui Dan Mendapat Penyuluhan PP ASI</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_ibu_nyusu" name="jml_ibu_nyusu" value="<?= old('jml_ibu_nyusu'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_aseptor_kondom" class="col-sm-5 col-form-label">Jumlah Peserta KB/Akseptor Dan Mendapat Kondom</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_aseptor_kondom" name="jml_aseptor_kondom" value="<?= old('jml_aseptor_kondom'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_aseptor_pi" class="col-sm-5 col-form-label">Jumlah Peserta KB/Akseptor Dan Mendapat Pil KB</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_aseptor_pi" name="jml_aseptor_pi" value="<?= old('jml_aseptor_pi'); ?>">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_aseptor_implant" name="jml_aseptor_implant" value="<?= old('jml_aseptor_implant'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_aseptor_mop" class="col-sm-5 col-form-label">Jumlah Peserta KB/Akseptor Dengan MOP</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_aseptor_mop" name="jml_aseptor_mop" value="<?= old('jml_aseptor_mop'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_aseptor_mow" class="col-sm-5 col-form-label">Jumlah Peserta KB/Akseptor Dengan MOW</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_aseptor_mow" name="jml_aseptor_mow" value="<?= old('jml_aseptor_mow'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_aseptor_iud" class="col-sm-5 col-form-label">Jumlah Peserta KB/Akseptor Memakai IUD</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_aseptor_iud" name="jml_aseptor_iud" value="<?= old('jml_aseptor_iud'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_aseptor_suntik" class="col-sm-5 col-form-label">Jumlah Peserta KB/Akseptor Mendapatkan Suntik</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_aseptor_suntik" name="jml_aseptor_suntik" value="<?= old('jml_aseptor_suntik'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_aseptor_lain" class="col-sm-5 col-form-label">Jumlah Peserta KB/Akseptor Memakai Kontrasepsi Lainnya</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_aseptor_lain" name="jml_aseptor_lain" value="<?= old('jml_aseptor_lain'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_balita_s_timbangL" class="col-sm-5 col-form-label">Jumlah Seluruh Balita Laki-laki (S)</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_balita_s_timbangL" name="jml_balita_s_timbangL" value="<?= old('jml_balita_s_timbangL'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_balita_s_timbangP" class="col-sm-5 col-form-label">Jumlah Seluruh Balita Perempuan (S)</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_balita_s_timbangP" name="jml_balita_s_timbangP" value="<?= old('jml_balita_s_timbangP'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_balita_kms_timbangL" class="col-sm-5 col-form-label">Jumlah Balita Laki-laki Memiliki KMS (K)</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_balita_kms_timbangL" name="jml_balita_kms_timbangL" value="<?= old('jml_balita_kms_timbangL'); ?>">
            </div>
        </div>
        <div class="form-group row">

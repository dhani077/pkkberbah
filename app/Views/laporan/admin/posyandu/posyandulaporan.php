...
<div class="row">
    <div class="col pt-5">
        <a class="btn pl-3" href="/pengunjungposyandu/range/<?= $posyandu['kd_posyandu']; ?>">
    ...
    <div class="col pt-5">
        <a class="btn" href="/posyandu/layananlaporan/<?= $posyandu['kd_posyandu']; ?>">
            <img src="/img/pengunjungposyandu.png" width="100" height="100"><br>Jenis Kegiatan/<br>Layanan
        </a>
    </div>
    <div class="col pt-5">
        <a class="btn" href="/kegiatanposyandu/range/<?= $posyandu['kd_posyandu']; ?>">
            <img src="/img/pelatihankader.png" width="100" height="100"><br>Data Kegiatan Posyandu
        </a>
    </div>
</div>
<br><br><br><br><br><br>
<a href="/posyandu/detaillaporan/<?= $kdwilayah; ?>" class="btn btn-danger">Kembali ke daftar posyandu</a>

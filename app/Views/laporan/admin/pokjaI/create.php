...
<div class="col">
    <h5 class="mb-5">Form Tambah Data Kegiatan Pokja I</h5>
    <form action="/PokjaICon/save" method="post" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        ...
        <div class="col">
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_kader_pkbn" name="jml_kader_pkbn" value="<?= old('jml_kader_pkbn'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_kader_pkdrt" class="col-sm-4 col-form-label">Jumlah kader PKDRT</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_kader_pkdrt" name="jml_kader_pkdrt" value="<?= old('jml_kader_pkdrt'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_kader_polaasuh" class="col-sm-4 col-form-label">Jumlah kader pola asuh</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_kader_polaasuh" name="jml_kader_polaasuh" value="<?= old('jml_kader_polaasuh'); ?>">
                </div>
            </div>
        </div>
        <hr>
        ...
        <div class="col">
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_klp_simulasi_pkbn" name="jml_klp_simulasi_pkbn" value="<?= old('jml_klp_simulasi_pkbn'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_anggota_pkbn" class="col-sm-4 col-form-label">Jumlah anggota kelompok PKBN</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_anggota_pkbn" name="jml_anggota_pkbn" value="<?= old('jml_anggota_pkbn'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_klp_simulasi_pkdrt" class="col-sm-4 col-form-label">Jumlah kelompok simulasi PKDRT</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_klp_simulasi_pkdrt" name="jml_klp_simulasi_pkdrt" value="<?= old('jml_klp_simulasi_pkdrt'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_anggota_pkdrt" class="col-sm-4 col-form-label">Jumlah anggota kelompok PKDRT</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_anggota_pkdrt" name="jml_anggota_pkdrt" value="<?= old('jml_anggota_pkdrt'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_klp_polaasuh" class="col-sm-4 col-form-label">Jumlah kelompok pola asuh</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_klp_polaasuh" name="jml_klp_polaasuh" value="<?= old('jml_klp_polaasuh'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_anggota_polaasuh" class="col-sm-4 col-form-label">Jumlah anggota kelompok pola asuh</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_anggota_polaasuh" name="jml_anggota_polaasuh" value="<?= old('jml_anggota_polaasuh'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_klp_lansia" class="col-sm-4 col-form-label">Jumlah kelompok lansia</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_klp_lansia" name="jml_klp_lansia" value="<?= old('jml_klp_lansia'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_anggota_lansia" class="col-sm-4 col-form-label">Jumlah anggota kelompok lansia</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_anggota_lansia" name="jml_anggota_lansia" value="<?= old('jml_anggota_lansia'); ?>">
                </div>
            </div>
        </div>
        <hr>
        ...
        <div class="col">
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_klp_kerjabakti" name="jml_klp_kerjabakti" value="<?= old('jml_klp_kerjabakti'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_klp_rknmati" class="col-sm-4 col-form-label">Jumlah kelompok rukun kematian</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_klp_rknmati" name="jml_klp_rknmati" value="<?= old('jml_klp_rknmati'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_klp_keagamaan" class="col-sm-4 col-form-label">Jumlah kelompok keagamaan</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_klp_keagamaan" name="jml_klp_keagamaan" value="<?= old('jml_klp_keagamaan'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_klp_jimpitan" class="col-sm-4 col-form-label">Jumlah kelompok jimpitan</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_klp_jimpitan" name="jml_klp_jimpitan" value="<?= old('jml_klp_jimpitan'); ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="jml_klp_arisan" class="col-sm-4 col-form-label">Jumlah kelompok arisan</label>
                <div class="col-sm-2">
                    <input type="number" class="form-control" id="jml_klp_arisan" name="jml_klp_arisan" value="<?= old('jml_klp_arisan'); ?>">
                </div>
            </div>
        </div>
        <hr>

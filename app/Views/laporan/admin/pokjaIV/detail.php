...
<div class="col">
    ...
    <div class="row">
        ...
        <!-- </?php if ($pokjaIV) : ?>
            <div class="col-md">
                <a class="btn btn-outline-secondary shadow float-right" href="/PokjaIVCon/print/<?= $tahun; ?>">Print
                </a>
            </div>
        </?php endif; ?> -->
    </div>
                    ...
                    <tr>
                        <?php foreach ($wilayah as $w) :
                            ...
                            if ($k['kd_wilayah'] == $w['kd_wilayah']) { ?>
                                ...
                                <td><?= $k['keterangan']; ?></td>
                                <td>
                                    <a href="/pokjaiv/edit/<?= $k['no']; ?>" class="btn btn-warning">Edit</a>
                                    <form action="/pokjaiv/<?= $k['no']; ?>" method="post" class="d-inline">
                                        <?= csrf_field(); ?>
    ...
    <br><br>
    <?php if ($pokjaIV) : ?>
        <a href="/pokjaiv/index" class="btn btn-outline-danger">Kembali ke daftar tahun</a>
    <?php endif; ?>
</div>

...
<div class="col">
    <h5 class="mb-5">Form Tambah Data Uang Masuk</h5>
    <form action="/UangmasukCon/save" method="post" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <div class="form-group row">
            <label for="tanggal" class="col-sm-3 col-form-label">Tanggal Uang Masuk</label>
            <div class="col-sm-3">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="number" class="form-control <?= ($validation->hasError('jml_terima')) ? 'is-invalid' : ''; ?>" id="jml_terima" name="jml_terima" value="<?= old('jml_terima'); ?>">
                <div class="invalid-feedback">

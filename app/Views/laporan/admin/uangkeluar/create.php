...
<div class="col">
    <h5 class="mb-5">Form tambah data uang keluar</h5>
    <form action="/UangkeluarCon/save" method="post" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <div class="form-group row">
            <label for="tanggal" class="col-sm-3 col-form-label">Tanggal uang keluar</label>
            <div class="col-sm-3">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control <?= ($validation->hasError('sumber_dana')) ? 'is-invalid' : ''; ?>" id="sumber_dana" name="sumber_dana" value="<?= old('sumber_dana'); ?>">
                <div class="invalid-feedback">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control <?= ($validation->hasError('no_bukti')) ? 'is-invalid' : ''; ?>" id="no_bukti" name="no_bukti" value="<?= old('no_bukti'); ?>">
                <div class="invalid-feedback">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="number" class="form-control <?= ($validation->hasError('jml_keluar')) ? 'is-invalid' : ''; ?>" id="jml_keluar" name="jml_keluar" value="<?= old('jml_keluar'); ?>">
                <div class="invalid-feedback">

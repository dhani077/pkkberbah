...
<div class="col">
    ...
    <form action="/CatatanibuhamilCon/save" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_ibu_melahir" name="jml_ibu_melahir" value="<?= old('jml_ibu_melahir'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_ibu_nifas" class="col-sm-3 col-form-label">Jumlah ibu nifas</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_ibu_nifas" name="jml_ibu_nifas" value="<?= old('jml_ibu_nifas'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_ibu_mngl" class="col-sm-3 col-form-label">Jumlah ibu meninggal</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_ibu_mngl" name="jml_ibu_mngl" value="<?= old('jml_ibu_mngl'); ?>">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_bayi_akte_ada" name="jml_bayi_akte_ada" value="<?= old('jml_bayi_akte_ada'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_bayi_akte_tidak" class="col-sm-3 col-form-label">Jumlah bayi tidak ada akte kelahiran</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_bayi_akte_tidak" name="jml_bayi_akte_tidak" value="<?= old('jml_bayi_akte_tidak'); ?>">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_balita_mnglL" name="jml_balita_mnglL" value="<?= old('jml_balita_mnglL'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_balita_mnglP" class="col-sm-3 col-form-label">Jumlah balita meninggal (Perempuan)</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_balita_mnglP" name="jml_balita_mnglP" value="<?= old('jml_balita_mnglP'); ?>">
            </div>
        </div>

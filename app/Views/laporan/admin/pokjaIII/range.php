...
<div class="col">
    <form action="/pokjaiii/lihatrange" method="post" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <p><b>Cetak data kegiatan POKJA III</b></p>
        ...
        <div class="form-group row"> -->
            <div class="col pt-5">
                <button id="aksi" name="aksi" type="submit" class="btn btn-success" value="print">Lihat</button>

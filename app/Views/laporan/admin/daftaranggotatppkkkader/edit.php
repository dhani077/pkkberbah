...
<div class="col">
    ...
    <form action="/DaftaranggotatppkkkaderCon/update" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="fotoLama" value="<?= $daftaranggota['foto']; ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control <?= ($validation->hasError('fungsi_anggota')) ? 'is-invalid' : ''; ?>" id="fungsi_anggota" name="fungsi_anggota" value="<?= (old('fungsi_anggota')) ? old('fungsi_anggota') : $daftaranggota['fungsi_anggota']; ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="fungsi_kader_umum" class="col-sm-3 col-form-label">Kedudukan/Fungsi sebagai kader umum</label>
            <div class="col-sm-6">
                <input type="text" class="form-control <?= ($validation->hasError('fungsi_kader_umum')) ? 'is-invalid' : ''; ?>" id="fungsi_kader_umum" name="fungsi_kader_umum" value="<?= (old('fungsi_kader_umum')) ? old('fungsi_kader_umum') : $daftaranggota['fungsi_kader_umum']; ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="fungsi_kader_khusus" class="col-sm-3 col-form-label">Kedudukan/Fungsi sebagai kader khusus</label>
            <div class="col-sm-6">
                <input type="text" class="form-control <?= ($validation->hasError('fungsi_kader_khusus')) ? 'is-invalid' : ''; ?>" id="fungsi_kader_khusus" name="fungsi_kader_khusus" value="<?= (old('fungsi_kader_khusus')) ? old('fungsi_kader_khusus') : $daftaranggota['fungsi_kader_khusus']; ?>">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <!-- <div class="custom-file">
                    ...
                    <label class="custom-file-label" for="foto" value="<?= (old('foto')) ? old('foto') : $daftaranggota['foto']; ?>"></label>
                </div> -->
                <div class="form-group row">
                    <label for="foto" class="col-sm-2 col-form-label">Foto</label>
                    <div class="col-sm-2">
                        <img src="/img/<?= $daftaranggota['foto']; ?>" class="img-thumbnail img-preview">
                    </div>
                    <div class="col-sm-8">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input <?= ($validation->hasError('foto')) ? 'is-invalid' : ''; ?>" id="foto" name="foto" onchange="previewImg()">
                            ...
                            <label class="custom-file-label" for="Foto"><?= $daftaranggota['foto']; ?></label>
                        </div>
                    </div>
                </div>
            </div>

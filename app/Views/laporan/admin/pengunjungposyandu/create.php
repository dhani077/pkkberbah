...
<div class="col">
    ...
    <form action="/DatapengunjungposyanduCon/save" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_pengunjung_sthun_baruL" name="jml_pengunjung_sthun_baruL" value="<?= old('jml_pengunjung_sthun_baruL'); ?>">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_pengunjung_sthun_baruP" name="jml_pengunjung_sthun_baruP" value="<?= old('jml_pengunjung_sthun_baruP'); ?>">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_pengunjung_sthun_lamaL" name="jml_pengunjung_sthun_lamaL" value="<?= old('jml_pengunjung_sthun_lamaL'); ?>">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_pengunjung_sthun_lamaP" name="jml_pengunjung_sthun_lamaP" value="<?= old('jml_pengunjung_sthun_lamaP'); ?>">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_pengunjung_limath_baruL" name="jml_pengunjung_limath_baruL" value="<?= old('jml_pengunjung_limath_baruL'); ?>">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_pengunjung_limath_baruP" name="jml_pengunjung_limath_baruP" value="<?= old('jml_pengunjung_limath_baruP'); ?>">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_pengunjung_limath_lamaL" name="jml_pengunjung_limath_lamaL" value="<?= old('jml_pengunjung_limath_lamaL'); ?>">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_pengunjung_limath_lamaP" name="jml_pengunjung_limath_lamaP" value="<?= old('jml_pengunjung_limath_lamaP'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_pengunjung_wus" class="col-sm-5 col-form-label">Jumlah wanita usia subur (WUS) yang datang</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_pengunjung_wus" name="jml_pengunjung_wus" value="<?= old('jml_pengunjung_wus'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_pengunjung_pus_ibu" class="col-sm-5 col-form-label">Jumlah pasangan usia subur (PUS) yang datang</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_pengunjung_pus_ibu" name="jml_pengunjung_pus_ibu" value="<?= old('jml_pengunjung_pus_ibu'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_pengunjung_hamil_ibu" class="col-sm-5 col-form-label">Jumlah ibu hamil yang datang</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_pengunjung_hamil_ibu" name="jml_pengunjung_hamil_ibu" value="<?= old('jml_pengunjung_hamil_ibu'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_pengunjung_nyusu_ibu" class="col-sm-5 col-form-label">Jumlah ibu menyusui yang datang</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_pengunjung_nyusu_ibu" name="jml_pengunjung_nyusu_ibu" value="<?= old('jml_pengunjung_nyusu_ibu'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_hadir_kader_l" class="col-sm-5 col-form-label">Jumlah kader (Laki-laki) yang aktif</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_hadir_kader_l" name="jml_hadir_kader_l" value="<?= old('jml_hadir_kader_l'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_hadir_kader_p" class="col-sm-5 col-form-label">Jumlah kader (Perempuan) yang aktif</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_hadir_kader_p" name="jml_hadir_kader_p" value="<?= old('jml_hadir_kader_p'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_hadir_plkb_l" class="col-sm-5 col-form-label">Jumlah petugas (Laki-laki) lapangan KB (PLKB) yang hadir</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_hadir_plkb_l" name="jml_hadir_plkb_l" value="<?= old('jml_hadir_plkb_l'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_hadir_plkb_p" class="col-sm-5 col-form-label">Jumlah petugas (Perempuan) lapangan KB (PLKB) yang hadir</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_hadir_plkb_p" name="jml_hadir_plkb_p" value="<?= old('jml_hadir_plkb_p'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_hadir_medis_l" class="col-sm-5 col-form-label">Jumlah tenaga medis dan para medis (Laki-laki) yang hadir</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_hadir_medis_l" name="jml_hadir_medis_l" value="<?= old('jml_hadir_medis_l'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_hadir_medis_p" class="col-sm-5 col-form-label">Jumlah tenaga medis dan para medis (Perempuan) yang hadir</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_hadir_medis_p" name="jml_hadir_medis_p" value="<?= old('jml_hadir_medis_p'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_bayi_lahirL" class="col-sm-5 col-form-label">Jumlah bayi lahir (Laki-laki)</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_bayi_lahirL" name="jml_bayi_lahirL" value="<?= old('jml_bayi_lahirL'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_bayi_lahirP" class="col-sm-5 col-form-label">Jumlah bayi lahir (Perempuan)</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_bayi_lahirP" name="jml_bayi_lahirP" value="<?= old('jml_bayi_lahirP'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_bayi_mnglL" class="col-sm-5 col-form-label">Jumlah bayi meninggal (Laki-laki)</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_bayi_mnglL" name="jml_bayi_mnglL" value="<?= old('jml_bayi_mnglL'); ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="jml_bayi_mnglP" class="col-sm-5 col-form-label">Jumlah bayi meninggal (Perempuan)</label>
            <div class="col-sm-2">
                <input type="number" class="form-control" id="jml_bayi_mnglP" name="jml_bayi_mnglP" value="<?= old('jml_bayi_mnglP'); ?>">
            </div>
        </div>

    ...
    public function save()
    {
        ...
        if ($btn == "tambah") {
            ...
            if (!$this->validate([
                ...
                'fungsi_anggota' => [
                    'rules' => 'required[daftaranggotakadertppkk.fungsi_anggota]',
                    'errors' => [
                        'required' => 'harus diisi!'
                    ]
                ],
                'fungsi_kader_umum' => [
                    'rules' => 'required[daftaranggotakadertppkk.fungsi_kader_umum]',
                    'errors' => [
                        'required' => 'harus diisi!'
                    ]
                ],
                'fungsi_kader_khusus' => [
                    'rules' => 'required[daftaranggotakadertppkk.fungsi_kader_khusus]',
                    'errors' => [
                        'required' => 'harus diisi!'
                    ]
                ],

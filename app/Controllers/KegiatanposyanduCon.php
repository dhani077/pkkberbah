    ...
    public function save($kdPosyandu)
    {
        ...
        if ($btn == "tambah") {
            ...
            $dataA = [
                ...
                'tahun' => $tahun,
                'bulan' => $bulan,
                'jml_ibu_hamil' => $jml_ibu_hamil,
                'jml_diperiksa' => $jml_diperiksa,
                'jml_fe_tab' => $jml_fe_tab,
                'jml_ibu_nyusu' => $jml_ibu_nyusu,
                'jml_aseptor_kondom' => $jml_aseptor_kondom,
                'jml_aseptor_pi' => $jml_aseptor_pi,
                'jml_aseptor_implant' => $jml_aseptor_implant,
                'jml_aseptor_mop' => $jml_aseptor_mop,
                'jml_aseptor_mow' => $jml_aseptor_mow,
                'jml_aseptor_iud' => $jml_aseptor_iud,
                'jml_aseptor_suntik' => $jml_aseptor_suntik,
                'jml_aseptor_lain' => $jml_aseptor_lain,
                'jml_balita_s_timbangL' => $jml_balita_s_timbangL,
                'jml_balita_s_timbangP' => $jml_balita_s_timbangP,
                'jml_balita_kms_timbangL' => $jml_balita_kms_timbangL,
                'jml_balita_kms_timbangP' => $jml_balita_kms_timbangP,
                'jml_balita_d_timbangL' => $jml_balita_d_timbangL,
                'jml_balita_d_timbangP' => $jml_balita_d_timbangP,
                'jml_balita_naik_timbangL' => $jml_balita_naik_timbangL,
                'jml_balita_naik_timbangP' => $jml_balita_naik_timbangP,
                'jml_balita_vita_timbangL' => $jml_balita_vita_timbangL,
                'jml_balita_vita_timbangP' => $jml_balita_vita_timbangP,
                'jml_balita_pmt_timbangL' => $jml_balita_pmt_timbangL,
                'jml_balita_pmt_timbangP' => $jml_balita_pmt_timbangP,
                'jml_imunisasi_ibu_I' => $jml_imunisasi_ibu_I,
                'jml_imunisasi_ibu_II' => $jml_imunisasi_ibu_II
            ];
            ...
            $dataB = [
                ...
                'tanggal' => $tanggal,
                'tahun' => $tahun,
                'jml_imunbayi_bcgl' => $jml_imunbayi_bcgl,
                'jml_imunbayi_bcgp' => $jml_imunbayi_bcgp,
                'jml_imunbayi_dpt_IL' => $jml_imunbayi_dpt_IL,
                'jml_imunbayi_dpt_IP' => $jml_imunbayi_dpt_IP,
                'jml_imunbayi_dpt_IIL' => $jml_imunbayi_dpt_IIL,
                'jml_imunbayi_dpt_IIP' => $jml_imunbayi_dpt_IIP,
                'jml_imunbayi_dpt_IIIL' => $jml_imunbayi_dpt_IIIL,
                'jml_imunbayi_dpt_IIIP' => $jml_imunbayi_dpt_IIIP,
                'jml_imunbayi_polio_IL' => $jml_imunbayi_polio_IL,
                'jml_imunbayi_polio_IP' => $jml_imunbayi_polio_IP,
                'jml_imunbayi_polio_IIL' => $jml_imunbayi_polio_IIL,
                'jml_imunbayi_polio_IIP' => $jml_imunbayi_polio_IIP,
                'jml_imunbayi_polio_IIIL' => $jml_imunbayi_polio_IIIL,
                'jml_imunbayi_polio_IIIP' => $jml_imunbayi_polio_IIIP,
                'jml_imunbayi_polio_IVL' => $jml_imunbayi_polio_IVL,
                'jml_imunbayi_polio_IVP' => $jml_imunbayi_polio_IVP,
                'jml_imunbayi_campakL' => $jml_imunbayi_campakL,
                'jml_imunbayi_campakP' => $jml_imunbayi_campakP,
                'jml_imunbayi_hepat_IL' => $jml_imunbayi_hepat_IL,
                'jml_imunbayi_hepat_IP' => $jml_imunbayi_hepat_IP,
                'jml_imunbayi_hepat_IIL' => $jml_imunbayi_hepat_IIL,
                'jml_imunbayi_hepat_IIP' => $jml_imunbayi_hepat_IIP,
                'jml_imunbayi_hepat_IIIL' => $jml_imunbayi_hepat_IIIL,
                'jml_imunbayi_hepat_IIIP' => $jml_imunbayi_hepat_IIIP,
                'jml_bltdiare_jmL' => $jml_bltdiare_jmL,
                'jml_bltdiare_jmP' => $jml_bltdiare_jmP,
                'jml_bltdiare_oralitL' => $jml_bltdiare_oralitL,
                'jml_bltdiare_oralitP' => $jml_bltdiare_oralitP,

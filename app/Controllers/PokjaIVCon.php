    ...
    public function save()
    {
        ...
        if ($btn == "tambah") {
            ...
            $data = [
                ...
                'jml_kader_posyandu' => $jml_kader_posyandu,
                'jml_kader_gizi' => $jml_kader_gizi,
                'jml_kader_kesling' => $jml_kader_kesling,
                'jml_kader_narkoba' => $jml_kader_narkoba,
                'jml_kader_phbs' => $jml_kader_phbs,
                'jml_kader_kb' => $jml_kader_kb,
                'jml_posyandu_ksht' => $jml_posyandu_ksht,
                'jml_posyandu_integrasi' => $jml_posyandu_integrasi,
                'jml_klp_lansia_posyandu' => $jml_klp_lansia_posyandu,
                'jml_anggota_lansia_posyandu' => $jml_anggota_lansia_posyandu,
                'jml_kartu_lansia_posyandu' => $jml_kartu_lansia_posyandu,
                'jml_rmh_jamban_kshtlh' => $jml_rmh_jamban_kshtlh,
                'jml_rmh_spal_kshtlh' => $jml_rmh_spal_kshtlh,
                'jml_rmh_sampah_kshtlh' => $jml_rmh_sampah_kshtlh,
                'jml_mck_kshtlh' => $jml_mck_kshtlh,
                'jml_air_pdam_kshtlh' => $jml_air_pdam_kshtlh,
                'jml_air_sumur_kshtlh' => $jml_air_sumur_kshtlh,
                'jml_air_lain_kshtlh' => $jml_air_lain_kshtlh,
                'jml_pus_rncnsehat' => $jml_pus_rncnsehat,
                'jml_wus_rncnsehat' => $jml_wus_rncnsehat,
                'jml_akseptorl_rncnsehat' => $jml_akseptorl_rncnsehat,
                'jml_akseptorp_rncnsehat' => $jml_akseptorp_rncnsehat,
                'jml_tabkel_rncnsehat' => $jml_tabkel_rncnsehat,

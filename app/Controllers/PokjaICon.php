    ...
    public function save()
    {
        ...
        if ($btn == "tambah") {
            ...
            $data = [
                ...
                'jml_kader_pkbn' => $jml_kader_pkbn,
                'jml_kader_pkdrt' => $jml_kader_pkdrt,
                'jml_kader_polaasuh' => $jml_kader_polaasuh,
                'jml_klp_simulasi_pkbn' => $jml_klp_simulasi_pkbn,
                'jml_anggota_pkbn' => $jml_anggota_pkbn,
                'jml_klp_simulasi_pkdrt' => $jml_klp_simulasi_pkdrt,
                'jml_anggota_pkdrt' => $jml_anggota_pkdrt,
                'jml_klp_polaasuh' => $jml_klp_polaasuh,
                'jml_anggota_polaasuh' => $jml_anggota_polaasuh,
                'jml_klp_lansia' => $jml_klp_lansia,
                'jml_anggota_lansia' => $jml_anggota_lansia,
                'jml_klp_kerjabakti' => $jml_klp_kerjabakti,
                'jml_klp_rknmati' => $jml_klp_rknmati,
                'jml_klp_keagamaan' => $jml_klp_keagamaan,
                'jml_klp_jimpitan' => $jml_klp_jimpitan,
                'jml_klp_arisan' => $jml_klp_arisan,
